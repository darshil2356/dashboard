...
//         .then((res) => res.json())
//         .then((data: ProductState) => setForm(data));
//     }
//   }, [isEdit, id]);

//   const handleInputChange = (field: keyof ProductState, value: string) => {
...
//           <h3 className="text-lg font-medium mb-4 text-gray-900 bg-gray-50 p-3 rounded-md">General Information</h3>

//           {/* Product Name */}
//           <div className="mb-6 p-3 bg-white  rounded-md">
//             <label className="block text-sm font-medium text-[#777980] mb-2">Product Name</label>
//             <input
//               type="text"
//               value={form.name}
...
//           <div className="mb-6 p-3 bg-white  rounded-md">
//             <label className="block text-sm font-medium text-[#777980] mb-2">Description</label>
...
//               className="w-full min-h-[120px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#2086BF] focus:border-transparent"
...
//             <label className="block text-sm font-medium text-[#777980] mb-2">Product Category</label>
//             <select
//               value={form.category}
...
//           {/* Tags */}
//           <div className="p-3 bg-white  rounded-md">
//             <label className="block text-sm font-medium text-[#777980] mb-2">Product Tags</label>
//             <input
//               type="text"
//               value={form.tags}
...
//   // Add this state and handler function inside your ProductForm component, after the existing useState hooks
//   const [imagePreviews, setImagePreviews] = useState<string[]>(
//     isEdit ? ["/path-to-smartwatch-image.jpg", "", ""] : ["", "", ""]
//   );
...
//   // For drag and drop functionality (optional enhancement), you can add these event handlers to each image slot div
//   // But for now, click-to-select is implemented. To add drag-drop, wrap each slot with onDragOver, onDrop, etc., and handle FileList.
...
//         {/* Left: General Information - 3/4 width on md+ */}
//         <div className="md:w-3/4">
//           <h3 className="text-lg font-medium mb-4 text-gray-900 bg-gray-50 p-3 rounded-md">
//             General Information
//           </h3>
...
//                 100 x 100 px image here, or click to add image
//               </p>
...
//         setForm(data);
//         if (data.variations) setImagePreviews(["", "", ""]); // Reset images if needed
//       });
//     }
//   }, [isEdit, id]);
